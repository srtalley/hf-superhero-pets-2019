...
if( $order_contains_gifts ) {
    echo esc_html__( 'Thanks for your gift order. It’s on-hold until we confirm that payment has been received. In the meantime, here’s a reminder of what you ordered:', 'woocommerce' ) . "\n\n";
} else {
