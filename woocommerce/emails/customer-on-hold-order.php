...
<?php if( $order_contains_gifts ) : ?>
    <p><?php esc_html_e( 'Thanks for your gift order. It’s on-hold until we confirm that payment has been received. In the meantime, here’s a reminder of what you ordered:', 'woocommerce' ); ?></p>
<?php else : ?>
